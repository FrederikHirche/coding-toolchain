...
| `github-board-sync.ps1` / `github-board-sync.sh` | Synchronisiert US/BUG/DEBT/IMPD-Artefakte mit einem optionalen GitHub Project (v2) Board — `-Mode push\|reconcile`, siehe `toolchain/protocols/github-board-sync.md` |
