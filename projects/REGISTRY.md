...
|---------|-------|--------|--------------|----------------|------|
| second-brain | REFINEMENT — Sprint 3 mit US-000013 und SP-000004 REVIEW; Gate 5 PASS; Sprint-2-Push/Cleanup weiterhin ausstehend | 3 | BA+FE+BE | 2026-07-31 | `projects/second-brain/` |
