...
| campaignworld | RELEASED (Sprint 17+18) — US-000023 (Wissensjournal), US-000026 (Sichtbarkeit & eigene Figur), US-000029 (Konflikterkennung), US-000041 (KI-Zugang/API-Token), US-000042 (Improvisationshilfen) ausgeliefert; RV-000017 v2.0 + RV-000018 v1.0 beide APPROVED; `feature/sprint-17`/`feature/sprint-18` per `--no-ff` nach `master` gemergt, Tag `v17-18` gesetzt (lokal — Push/Worktree-Cleanup/Board-Sync-Push stehen noch mit expliziter Nutzerbestätigung aus). Kein formaler `ADR-NNNNNN-branching-strategy.md` — Nutzer hat den Merge direkt angewiesen (`master` als einziger Trunk-Branch). BUG-000023 (MAJOR)/BUG-000024 (MINOR) offen, kein Blocker; DEBT-000031 TEILWEISE BEHOBEN, DEBT-000032 neu | 18 | ORCH | 2026-08-08 | `projects/campaignworld/` |
