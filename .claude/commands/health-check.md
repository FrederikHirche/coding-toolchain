...
1. Liest ALLE verfügbaren Sprint-Daten des Projekts:
   ...
   - Alle `RV-NNNNNN` (wiederkehrende Review-Finding-Kategorien)
...
3. Erstellt PC-NNNNNN mit 3–7 priorisierten Verbesserungsvorschlägen
   (je Vorschlag: Problem → Ursache → Empfehlung → betroffene Dateien → Aufwand S/M/L)

## Vorbedingungen

- Mindestens 3 abgeschlossene Sprints empfohlen
- Mindestens `RV-NNNNNN` und `TR-NNNNNN` aus vergangenen Sprints vorhanden

## Ergebnis

Ein `PC-NNNNNN` mit priorisierten, konkreten Verbesserungsvorschlägen für die Tool Chain —
nach Impact/Aufwand-Verhältnis geordnet.

---

**Agent:** AC (Agile Coach)
**Input:** Alle Sprint-Artefakte des Projekts, `DECISIONS.md`, alle `RETRO-NNNNNN`
**Output:** `PC-NNNNNN`
