...
7. Bildet Epics (`EPIC-NNNNNN`) aus zusammengehörigen Stories
8. Erstellt die Roadmap (`RM-NNNNNN`) — plant den GESAMTEN Projekt-Scope vor (nicht nur den
   nächsten Sprint): Priorität, Schätzung, Size, Iteration und Zeitrahmen je Story
9. Aktualisiert `projects/<projektname>/INDEX.md`
10. Falls `github.enabled: true`: synchronisiert den gesamten vorausgeplanten Backlog
    (Epics als Milestones, Stories mit Estimate/Size/Priority/Iteration/Datum) auf das
    GitHub Project Board (siehe `toolchain/protocols/github-board-sync.md`)
11. Gibt Übergabe-Zusammenfassung für `/architect` aus
...
**Input:** `SB-NNNNNN`
**Output:** `REQ-NNNNNN`, `US-NNNNNN`, `EPIC-NNNNNN`, `RM-NNNNNN`
**Templates:** `toolchain/templates/requirements.md`, `toolchain/templates/user-story.md`,
`toolchain/templates/epic.md`, `toolchain/templates/roadmap.md`
